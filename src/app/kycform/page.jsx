...
export default function KYCPage() {
  ...
  const fetchFormUrl = async () => {
    ...
    try {
      console.log('Fetching form URL with transactionId:', transactionId);
      ...
      if (response.data?.formUrl && response.data?.formId) {
        ...
        // No need to call pollKycStatus here as it will be triggered by the useEffect
      } else {
  ...
  const checkKycStatus = async () => {
    console.log('Checking KYC status:', formId,'-----', transactionId);
  ...
  const pollKycStatus = async () => {
    ...
    if (status && status !== 'PENDING') {
      ...
      console.log('KYC still pending, will check again in 5 seconds')
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!transactionId ? (
          ...
          >
            ...
            >
              Please wait while we prepare your KYC verification
            </motion.p>
          </motion.div>
        ) : loading ? (
          formUrl ? (
            ...
            >
              <div className="p-4 border-b border-gray-100">
                <h2 className="text-lg font-medium text-gray-800 mb-1">Complete Your KYC</h2>
                <p className="text-gray-500 text-sm mb-4">Please complete the verification form to proceed</p>
                ...
                <p className="text-gray-500 text-xs">Note: After completing the form, return to this page to check your verification status</p>
              </div>
              ...
              >
                <div className="flex items-center mb-2">
                  <motion.div 
                    ...
                    animate="animate"
                  />
                  <p className="text-sm font-medium text-gray-700">Waiting for verification...</p>
                </div>
                <p className="text-xs text-gray-500">We'll automatically update this page when your verification is complete</p>
              </motion.div>
            ...
            {kycStatus?.kycStatus === 'SUCCESS' ? (
              ...
              >
                ...
                >
                  ...
                  >
                    Your identity verification is complete. You can now proceed to set up your eMandate for automatic payments.
                  </motion.p>
                  ...
                  >
                    ...
                    >
                      <Button 
                        variant="outline"
                        className="w-full bg-transparent border border-white text-white hover:bg-white hover:bg-opacity-10 font-medium py-5 h-auto rounded-xl"
              ...
              >
                ...
                <motion.div className="text-center">
                  ...
                  >
                    ...
                    <p className="text-gray-700">{kycStatus.reason || 'Not specified'}</p>
                  </motion.div>
              ...
              >
                <motion.h2 
                  ...
                  className="text-xl font-bold mb-3 text-gray-800"
                >
                  KYC Status: {kycStatus?.kycStatus || 'Unknown'}
                </motion.h2>
                ...
                >
                  We received an unexpected status for your KYC verification.
                </motion.p>
